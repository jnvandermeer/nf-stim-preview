...
if __name__=="__main__":
    ...
    v['MONITOR_PIXWIDTH']=1440
    v['MONITOR_PIXHEIGHT']=900
...
for key in v.keys():
    logging.data("{key}: {value}".format(key=key, value=v[key]))
logging.data("---------------------------")
logging.data("---------------------------")
...
# let's write a very simple (other) event hander multiprocessing class, and test that.
import multiprocessing
